...
echo "<h2>สร้างตารางสำหรับลูกค้า</h2>";
...
$sample_customers = [
    ...
    [
        'email' => 'somsak.chaidee@example.com',
        'password' => 'password123',
        'first_name' => 'สมศักดิ์',
        'last_name' => 'ใจดี',
        'phone' => '0834567890',
...
echo "<p><strong>ตารางที่สร้าง:</strong></p>";
echo "<ul>";
...
echo "<p><strong>ข้อมูลตัวอย่าง:</strong> สร้างลูกค้าตัวอย่าง 3 คน (John Doe, Jane Smith, สมศักดิ์ ใจดี)</p>";
echo "<p><strong>Email:</strong> john.doe@example.com, jane.smith@example.com, somsak.chaidee@example.com</p>";
echo "<p><strong>Password:</strong> password123 (สำหรับทุกคน)</p>";
?>
...
<body>
    <div style="background-color: white; padding: 30px; border-radius: 10px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
        ...
        <div style="margin-top: 30px;">
            ...
            <p>ระบบได้สร้างตารางสำหรับจัดการข้อมูลลูกค้าเรียบร้อยแล้ว</p>
